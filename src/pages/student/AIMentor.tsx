...
const initialMessages: Message[] = [
  ...
  },
  {
    id: 5,
    role: "ai",
    text: "Based on your gap analysis, your Digital Competency score is 32 against a target of 80 — that's a 48-point gap, which is your largest and most critical gap.\n\nHere's a focused action plan:\n\n1. Start immediately with 'Digital Governance Fundamentals' on iGOT — it's already in your learning path (Phase 2) and you're 65% through. Completing this is your top priority this week.\n\n2. After that, take 'e-Governance & Digital India' (6h, Internal) — it covers the policy and platform landscape in depth.\n\n3. Build practical skills: explore GeM and UMANG as a user to understand the citizen experience firsthand.\n\n4. For your assessment prep, focus on topics like the Digital India pillars, Data Protection Bill 2023, and PM GatiShakti.\n\nAt your current pace, you can reduce this gap from 48 to under 20 points within 3–4 weeks of consistent study. Would you like me to create a daily study schedule for this?",
    time: "9:05 AM",
  },
];
