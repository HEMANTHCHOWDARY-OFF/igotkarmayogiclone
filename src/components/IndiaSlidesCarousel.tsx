...
const slides = [
  ...
  },
  {
    ...
    badgeEng: "MoSPI — DIID",
    emoji: "📊",
    title: "Official Statistical\nModernization",
    subTitle: "Ministry of Statistics & Programme Implementation",
    tagline:
      "Upskilling 12,000+ statistical officers in AI, Big Data, GIS and modern survey methodologies.",
    pills: ["MoSPI DIID", "NSSTA Academy", "FrAC Standards"],
    stat: { value: "12,000+", label: "Statistical Officers" },
    image: "/slide2.jpg",
  },
  {
    id: 3,
